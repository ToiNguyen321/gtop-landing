  ...
  return (
    <section id="faq" className="py-10 lg:py-20">
      <div className="flex flex-col lg:flex-row gap-10">
        <div className="">
          <p className="hidden lg:block text-foreground-accent">CÂU HỎI</p>
          <SectionTitle>
            <h2 className="my-3 !leading-snug lg:max-w-sm text-center lg:text-left">
              Câu hỏi thường gặp về GTop
            </h2>
          </SectionTitle>
          <p className="lg:mt-10 text-foreground-accent text-center lg:text-left">
            Nếu bạn vẫn còn thắc mắc, đừng ngần ngại liên hệ với chúng tôi nhé!
          </p>
          <a
            href="mailto:help@gtop.app"
